...
info = Label(
    root,
    text="Enter your weight in kg and height in meter",
    font=("arial", 15),
    fg="grey",
)
...
height = Label(root, text="Height", font=("Century", 18)).place(
    x=60, y=40, height=40, width=130
)
...
weight = Label(root, text="Weight", font=("Century", 18)).place(
    x=60, y=100, height=40, width=130
)
...
btn = Button(
    root, text="Submit", font=("ALGERIA", 20), cursor="hand2", command=fun
